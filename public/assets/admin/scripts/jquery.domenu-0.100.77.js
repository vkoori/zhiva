...
(function ($, window, document, undefined) {
  ...
  Plugin.prototype = {
    ...
    dragStart:                          function (e) {
      ...
      mouse.offsetX = e.offsetX !== undefined ? e.offsetX : e.pageX - document.getElementById("domenu-0").clientWidth + target.offset().left;
      ...
      // element
      this.$dragItem.css({
        'left': e.pageX - document.getElementById("domenu-0").clientWidth + mouse.offsetX,
