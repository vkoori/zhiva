        ...
        <section class="flex-center">
            <div class="img-rounded border p-1em text-center">
                <form method="post" action="{{ url()->full() }}" accept-charset="utf-8">
                    ...
                    <p class="mr-b-1em">«رمز عبور» دلخواه خود و «کد تایید» پیامک شده را وارد کنید</p>
                    @if($errors->any())
                        @foreach($errors->all() as $error)
                        <p class="text-danger mr-b-1em">{{ $error }}</p>
                        @endforeach
                    @endif
                    <input class="w-100 mr-b-1em" name="psw" type="password" placeholder="رمز عبور">
                    <input class="w-100 mr-b-1em" name="key" type="number" placeholder="کد پیامک شده">
                    <input type="submit" class="img-rounded w-100 mr-b-1em bt-blue" value="ثبت نام">
                    <p>ثبت نام در سامانه ژیوافیت به منزله پذیرفتن <a href="" title="قوانین">قوانین و مقررات</a> میباشد.</p>
